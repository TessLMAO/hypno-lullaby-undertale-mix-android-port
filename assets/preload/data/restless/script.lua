...
local xx3 = 600; -- Same code as above, but for girlfriend left, right
local yy3 = 450; -- Same code as above, but for girlfriend, up, down
local ofs = 30; -- Code to adjust the intensity with which the camera moves, the more numbers, the more intense, and the fewer numbers, less intense
...
function onCreate()
    setProperty('boyfriend.visible', false) --false if you dont want him to be visible

    setProperty('gf.visible', true) --true if you dont want gf to be visible
